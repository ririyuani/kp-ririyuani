          ...
          <div class="row">
            <div class="col-12 col-lg-8">
              <ul class="list-unstyled">
                <li class="media">
                  <img src="/images/testimonial-1.png" alt="" class="mr-3 rounded-circle" />
                  <div class="media-body">
                    <h5 class="mt-2 mb-1">Clarin</h5>
                ...
                <li class="media">
                  <img src="/images/testimonial-2.png" alt="" class="mr-3 rounded-circle" />
                  <div class="media-body">
                ...
                <li class="media">
                  <img src="/images/testimonial-3.png" alt="" class="mr-3 rounded-circle" />
                  <div class="media-body">
                    <h5 class="mt-2 mb-1">Elsa</h5>
